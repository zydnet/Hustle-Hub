...
export default function AddResumeOrJobPreferences() {
  ...
  const labelClass =
    "block text-sm mb-1 text-[#bdbdbd] font-medium";
  const buttonClass =
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#181818] py-6 px-2">
      <div className="w-full max-w-xl">
        <form
          onSubmit={handleSubmit}
          className="bg-[#181818] rounded-2xl shadow-xl p-8 text-[#e6e6e6] max-h-[85vh] overflow-y-auto max-sm:p-4"
          autoComplete="off"
        >
          <h2 className="text-2xl font-bold mb-6 text-center text-[#77e1f1]">
          ...
          {submitted && (
            <div className="text-green-400 font-bold mt-4 text-center">
