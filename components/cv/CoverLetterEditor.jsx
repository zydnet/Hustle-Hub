...
export default function CoverLetterEditor({ applications = [] }) {
   ...
   // Theme classes
   const card =
      'rounded-2xl bg-[#181818] shadow-xl p-6 my-6 border border-[#353535] max-w-2xl w-full mx-auto';
   const input =
   ...
   return (
      <div className="flex min-h-[80vh] flex-col items-center bg-[#111111] px-2 py-6">
         <div className={card}>
            <h2 className="mb-6 text-2xl font-bold text-[#e5e5e5]">
               Personalized CV/LTR Builder
            </h2>
            ...
            <div className="flex gap-3">
               <button
                  ...
                  className="rounded-lg bg-gradient-to-br from-[#45aaff] to-[#2b4d8c] px-4 py-2 text-white shadow transition hover:bg-blue-600"
               >
                  Copy as Text
               </button>
               <button
                  onClick={downloadAsPDF}
                  className="rounded-lg border border-blue-400 bg-[#232222] px-4 py-2 text-blue-200 shadow transition hover:bg-[#1e385a]"
               >
                  Download as PDF
               </button>
            </div>
